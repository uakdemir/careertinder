"""Tests for dashboard modules — importability and helper functions."""
...
class TestFormatRelativeTime:
    """Tests for format_relative_time() shared utility."""
    ...
    def test_just_now(self) -> None:
        ...
        result = format_relative_time(datetime.now(UTC))
